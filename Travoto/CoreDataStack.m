...
static CoreDataStack *dataStack;
...
+(CoreDataStack *) dataStack{
    ...
    if (!dataStack) {
        dataStack = [[CoreDataStack alloc] init];
    }
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.lt.coreData" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Travoto" withExtension:@"momd"];
